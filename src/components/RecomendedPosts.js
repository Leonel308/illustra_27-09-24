...
import { collection, getDocs, doc, deleteDoc, getDoc, query, where, limit } from 'firebase/firestore';
import '../Styles/RecomendedPosts.css'; 
...
const RecomendedPosts = ({ collectionName }) => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        const q = query(postsCollection, where("isAdultContent", "==", false), limit(15)); // Filtrar por SFW
